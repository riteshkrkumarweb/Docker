...
class UserInput(BaseModel):
    ...
    height:Annotated[float,Field(...,gt=0,lt=2.5, description='Enter the height in meter')]
    income_lpa:Annotated[float,Field(...,gt=0,description='Enter the Amount in Lpa')]
    smoker:Annotated[bool,Field(...,description='Is the person smoker or not ')]
    city:Annotated[str,Field(...,description='Enter the city You belong to')]
...
# Endpoint
@app.post('/predict')
def predict_user(data:UserInput):
